...
죽냐사냐는 관계 X
재발을 하냐 마냐는 그룹간의 차이가 존재
트리트먼트 3 (호르몬)의 재발율이 제일 높다
PSA가 얼마나 감소했는가는 그룹1 (수술) 만 혼자 낮음, 나머지는 차이가 없음
