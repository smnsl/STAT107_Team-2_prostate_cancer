...
Treatment Effectiveness in Patients with Prostate Cancer 
...
table_initial %>%
  kable(caption = "Table 1: Initial Diagnosis Variables", booktabs = TRUE) %>%
...
table_risk %>% 
  kable(caption = "Table 2: Risk Factors", booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position") %>%
  column_spec(2, width = "6cm")
...
kable(table_info, caption = "Treatment Information")
...
table_marker %>%
  kable(caption = "Table 4: Pathological Markers", booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position") %>%
  column_spec(2, width = "6cm") 
...
table_marker %>% 
  kable(caption = "Table 5: Follow-up \\& Outcomes", booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position") %>%
