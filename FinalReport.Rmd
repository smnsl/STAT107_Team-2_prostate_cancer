...
figure 2: Side-by-side bar plots for Biochemical Recurrence (BCR) and Survival Status to display the main outcomes. Preliminary findings suggest a differential effect of treatments on recurrence.
...
```
진찰시에는 수치가 높았는데 treatment 후에는 수치가 많이 줄었다.
